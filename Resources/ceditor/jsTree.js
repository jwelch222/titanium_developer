...
var jst_image_folder = "./ceditor/images/"
var jst_image_folder_user = "./ceditor/images/"
...
function renderChildren(strData, tblCls, menu){
	...
	for(var n in nodes){
		code.push('<tr><td style="height:20px !important;"><img' + (strData == jst_data ? ' style="display:none" id="jst_rootImage"' : '') + ' src="' + jst_image_folder + '/')
...
//	TestDate = new Date();TestStartZeit=TestDate.getTime();
	...
	jst_cm = document.getElementById("jst_contextMenu")
